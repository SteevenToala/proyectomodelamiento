			...
			<div class="box-container">
				<div class="box">
					...
					<div class="flex-box">
						...
						<a href="all_category.php" class="btn">Ver todas las categorias</a>
					</div>
				</div>
		...
		<section class="posts-container">
			...
			<div class="box-container">
				...
				if ($select_posts->rowCount() > 0) {
					while ($fetch_posts = $select_posts->fetch(PDO::FETCH_ASSOC)) {
						...
						<form class="box" method="post">
							...
							<div class="icons">
								...
								<a href="" type="submit" name="like_post">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
					...
					echo '<p class="empty">Sin post aun!</p>';
				}
				?>
			</div>

			<div class="more-btn">
				<!-- <a href="posts.php" class="inline-btn">Ver todos los posts</a> -->
			</div>
